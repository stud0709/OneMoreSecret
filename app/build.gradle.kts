...
dependencies {
    ...
    implementation("androidx.compose.ui:ui-tooling-preview:1.7.8") // Preview support
    debugImplementation("androidx.compose.ui:ui-tooling:1.7.8")  // Enables preview rendering in Android Studio
