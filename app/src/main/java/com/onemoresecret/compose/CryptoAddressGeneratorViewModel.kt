...
import com.onemoresecret.KeyStoreListFragment
...
class CryptoAddressGeneratorViewModel(application: Application, val resourceProvider: ResourceProvider) :
    ...
    val btnBackupEnabled = mutableStateOf(false);
