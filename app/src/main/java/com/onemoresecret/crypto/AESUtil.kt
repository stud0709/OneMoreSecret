...
object AESUtil {
    ...
    fun process(
        cipherMode: Int, input: ByteArray?,
        key: SecretKey?,
        iv: IvParameterSpec?,
    ...
    private const val PROP_AES_KEY_LENGTH: String = "aes_key_length"
    private const val PROP_AES_KEY_ITERATIONS: String = "aes_key_iterations"
    private const val PROP_AES_SALT_LENGTH: String = "aes_salt_length"
    private const val PROP_AES_TRANSFORMATION_IDX: String = "aes_transformation_idx"
    private const val PROP_AES_KEY_ALGORITHM_IDX: String = "aes_key_algorithm_idx"
    ...
    fun getAesTransformation(preferences: SharedPreferences): AesTransformation {
        return AesTransformation.entries[getAesTransformationIdx(
            preferences
        )]
    }
    ...
    fun getAesKeyAlgorithm(preferences: SharedPreferences): AesKeyAlgorithm {
        return AesKeyAlgorithm.entries[getAesKeyAlgorithmIdx(
            preferences
        )]
    }
